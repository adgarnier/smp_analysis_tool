...
# image_path = os.path.join('C:', 'Users', 'u1179378', 'OneDrive - IQVIA', 'Documents', 'python', 'images', 'IMG_4666.png')
...
class Application(tk.Frame):
    ...
    def icon_image(self):
        self.image_path = r'C:\Users\u1179378\OneDrive - IQVIA\Documents\python\smp analysis tool\images\IMG_4666.png'
    ...
    def check_progress(self):
        ...
        if self.process.poll() is None and not self.find_window_by_title('Script Status'):
    ...
    def finish_script(self):
        ...
        if not self.script_aborted and not self.find_window_by_title('Script Status'):
...
Full: Still under development 🙂.")
    ...
    def abort_script(self):
        ...
        if hasattr(self, 'process') and self.process is not None:
            ...
            messagebox.showerror("Script Status", "Execution aborted.")
