...
namespace eval ttk::theme::azure-light {
    ...
    ttk::style theme create azure-light -parent clam -settings {
        ...
        # Progressbar
        ttk::style element create Horizontal.Progressbar.trough image $I(hor-basic_edit) \
            -sticky ew

        ttk::style element create Horizontal.Progressbar.pbar image $I(hor-accent_edit) \
            -sticky ew
